...
class Trunk(models.Model):
    ...
    sip_interface = models.ForeignKey('base.SipInterface', verbose_name="端口(Profile)", related_name='gateways')
    context = models.ForeignKey('base.Context', verbose_name="路由组(Context)", default=1, related_name='context_trunks')
...
class TrunkRoutePattern(models.Model):
    ...
    prepend = models.CharField('呼叫前缀', max_length=64, blank=True,null=True)

    class Meta:
        app_label = 'base'
        verbose_name = u'配置路由规则'
        verbose_name_plural = verbose_name
